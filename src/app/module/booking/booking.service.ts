...
// check availability
// find facility exist
const isFacilityExist= await Facility.findOne({_id: paylod.facility, isDeleted: false}).exec()
if(!isFacilityExist){
    throw new AppError(httpStatus.NOT_FOUND, "Facility not found")
}

const payableAmount = calculatePayableAmount(startTime!, endTime!, isFacilityExist.pricePerHour)
